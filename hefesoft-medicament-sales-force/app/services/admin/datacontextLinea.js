(function () {
    ...
    var serviceId = 'datacontextLinea';
    angular.module('app').factory(serviceId,
        ['common', 'AzureMobileClient', datacontextLinea]);

    function datacontextLinea(common, AzureMobileClient) {
        var $q = common.$q;
        ...
        function get() {
            ...
            AzureMobileClient.getAllData('tp_linea', 50).then(
                    function (resultado) {
        ...
        function dataSourceCreate(options) {
            ...
            AzureMobileClient.addDataAsync("tp_linea", item).then(
                function(result){
                    options.success(result);
                    },
                function (err) {
        ...
        function dataSourceUpdate(options) {
            var item = options.data;            
            AzureMobileClient.updateDataAsync("tp_linea", item).then(
                function (result) {
                    options.success(result);
                },
                function (err) {
        ...
        function dataSourceDestroy(options) {
            ...
            AzureMobileClient.deleteDataAsync("tp_linea", item).then(
                function (result) {
