(function () {
    ...
    var serviceId = 'datacontextProductoCampo';
    angular.module('app').factory(serviceId,
        ['common', 'AzureMobileClient', datacontextProductoCampo]);

    function datacontextProductoCampo(common, AzureMobileClient) {
        var $q = common.$q;
        ...
        function get() {
            ...
            AzureMobileClient.getAllData('tp_producto_campo', 50).then(
                    function (resultado) {
        ...
        function dataSourceCreate(options) {
            ...
            AzureMobileClient.addDataAsync("tp_producto_campo", item).then(
                function(result){
                    options.success(result);
                    },
                function (err) {
        ...
        function dataSourceUpdate(options) {
            var item = options.data;            
            AzureMobileClient.updateDataAsync("tp_producto_campo", item).then(
                function (result) {
                    options.success(result);
                },
                function (err) {
        ...
        function dataSourceDestroy(options) {
            ...
            AzureMobileClient.deleteDataAsync("tp_producto_campo", item).then(
                function (result) {
