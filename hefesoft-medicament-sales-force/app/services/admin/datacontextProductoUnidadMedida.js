(function () {
    ...
    var serviceId = 'datacontextProductoUnidadMedida';
    angular.module('app').factory(serviceId,
        ['common', 'AzureMobileClient', datacontextProductoUnidadMedida]);

    function datacontextProductoUnidadMedida(common, AzureMobileClient) {
        var $q = common.$q;
        ...
        function get() {
            ...
            AzureMobileClient.getAllData('tp_producto_unidad_medida', 50).then(
                    function (resultado) {
        ...
        function dataSourceCreate(options) {
            ...
            AzureMobileClient.addDataAsync("tp_producto_unidad_medida", item).then(
                function(result){
                    options.success(result);
                    },
                function (err) {
        ...
        function dataSourceUpdate(options) {
            var item = options.data;            
            AzureMobileClient.updateDataAsync("tp_producto_unidad_medida", item).then(
                function (result) {
                    options.success(result);
                },
                function (err) {
        ...
        function dataSourceDestroy(options) {
            ...
            AzureMobileClient.deleteDataAsync("tp_producto_unidad_medida", item).then(
                function (result) {
